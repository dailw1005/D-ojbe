...
import com.ojbe.model.dto.question.JudgeCase;
import com.ojbe.model.dto.question.JudgeConfig;
import com.ojbe.model.dto.questionsubmit.JudgeInfo;
...
public class JudgeServiceImpl implements JudgeService {
    ...
    public QuestionSubmit doJudge(long questionSubmitId) {
        ...
        if (executeCodeResponse.getTestCaseResults() != null) {
            List<com.ojbe.model.dto.questionsubmit.JudgeCaseResult> resultList = executeCodeResponse.getTestCaseResults().stream().map(r -> {
                com.ojbe.model.dto.questionsubmit.JudgeCaseResult res = new com.ojbe.model.dto.questionsubmit.JudgeCaseResult();
