...
import com.dailw.mapper.CompetitionMapper;
import com.dailw.mapper.CompetitionQuestionMapper;
...
import com.dailw.utils.RedisDistributedLock;
...
public class CompetitionRankingServiceImpl implements CompetitionRankingService {
    ...
    @Resource
    private com.dailw.mapper.QuestionSubmitMapper questionSubmitMapper;

    @Resource
    private com.dailw.mapper.CompetitionRegistrationMapper competitionRegistrationMapper;
    ...
    private int calculateOiSubmissionScore(QuestionSubmit submit, int maxScore) {
        ...
        try {
            ...
            com.dailw.model.dto.questionsubmit.JudgeInfo judgeInfo =
                    com.dailw.utils.StaticJsonUtil.toObj(judgeInfoStr,
                            com.dailw.model.dto.questionsubmit.JudgeInfo.class);
            ...
            long passed = results.stream()
                    .filter(r -> com.dailw.model.enums.JudgeInfoMessageEnum.ACCEPTED.getValue()
                            .equals(r.getStatus()))
                    .count();
    ...
    public void rebuildRankings(Long contestId) {
        ...
        com.dailw.utils.RedisDistributedLock.LockInfo lockInfo =
