...
public class QuestionSubmitVO implements Serializable {
    ...
    public static QuestionSubmit voToObj(QuestionSubmitVO questionSubmitVO) {
        ...
        if (judgeInfoObj != null) {
            questionSubmit.setJudgeInfo(com.dailw.utils.StaticJsonUtil.toJsonStr(judgeInfoObj));
        }
    ...
    public static QuestionSubmitVO objToVo(QuestionSubmit questionSubmit) {
        ...
        if (judgeInfoStr != null && !judgeInfoStr.isEmpty()) {
            questionSubmitVO.setJudgeInfo(com.dailw.utils.StaticJsonUtil.toObj(judgeInfoStr, JudgeInfo.class));
        }
